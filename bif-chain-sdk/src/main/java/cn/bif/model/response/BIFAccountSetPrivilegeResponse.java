...
public class BIFAccountSetPrivilegeResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFAccountSetPrivilegeResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFAccountSetPrivilegeResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFAccountSetPrivilegeResult result) {
