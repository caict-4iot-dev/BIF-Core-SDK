...
public class BIFAccountPrivResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFAccountPrivResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFAccountPrivResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFAccountPrivResult result) {
