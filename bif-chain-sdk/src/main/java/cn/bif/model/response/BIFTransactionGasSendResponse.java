...
public class BIFTransactionGasSendResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFTransactionGasSendResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFTransactionGasSendResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFTransactionGasSendResult result) {
