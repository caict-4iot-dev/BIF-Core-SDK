...
public class BIFContractGetInfoResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFContractGetInfoResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFContractGetInfoResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFContractGetInfoResult result) {
