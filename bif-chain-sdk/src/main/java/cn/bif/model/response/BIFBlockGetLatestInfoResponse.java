...
public class BIFBlockGetLatestInfoResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFBlockGetLatestInfoResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFBlockGetLatestInfoResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFBlockGetLatestInfoResult result) {
