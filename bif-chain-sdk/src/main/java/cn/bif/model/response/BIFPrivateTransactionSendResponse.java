...
public class BIFPrivateTransactionSendResponse extends BIFBaseResponse {
     ...
     * @Method getResult
     * @Params []
     * @Return PrivateTransactionSendResult
     */
     ...
     * @Return void
     */
    public void setResult(BIFPrivateTransactionSendResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFPrivateTransactionSendResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFPrivateTransactionSendResult result) {
