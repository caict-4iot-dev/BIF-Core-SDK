...
public class BIFTransactionCacheResponse extends BIFBaseResponse {
    ...
    public void setResult(BIFTransactionCacheResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFTransactionCacheResult result) {
        this.errorCode = sdkError.getCode();
        this.errorDesc = sdkError.getDescription();
        this.result = result;
    }

    public void buildResponse(int errorCode, String errorDesc, BIFTransactionCacheResult result) {
