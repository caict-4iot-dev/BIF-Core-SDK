...
public class BIFBlockGetValidatorsResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFBlockGetValidatorsResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFBlockGetValidatorsResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFBlockGetValidatorsResult result) {
