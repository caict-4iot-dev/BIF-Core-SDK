...
public class BIFContractCallPrivateResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFContractCallPrivateResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFContractCallPrivateResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFContractCallPrivateResult result) {
