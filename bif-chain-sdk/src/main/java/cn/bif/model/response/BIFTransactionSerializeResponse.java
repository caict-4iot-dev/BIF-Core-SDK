...
public class BIFTransactionSerializeResponse extends BIFBaseResponse {
     ...
     * @Method getResult
     * @Params []
     * @Return BIFTransactionSerializeResult
     */
     ...
     * @Return void
     */
    public void setResult(BIFTransactionSerializeResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFTransactionSerializeResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFTransactionSerializeResult result) {
