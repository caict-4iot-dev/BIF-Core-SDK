...
public class BIFContractCreateResponse extends BIFBaseResponse {
     ...
     * @Method getResult
     * @Params []
     * @Return BIFContractCreateResult
     */
     ...
     * @Return void
     */
    public void setResult(BIFContractCreateResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFContractCreateResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFContractCreateResult result) {
