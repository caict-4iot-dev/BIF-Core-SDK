...
public class BIFPrivateTransactionReceiveRawResponse extends BIFBaseResponse {
     ...
     * @Method getResult
     * @Params []
     * @Return PrivateTransactionReceiveRawResult
     */
     ...
     * @Return void
     */
    public void setResult(BIFPrivateTransactionReceiveRawResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFPrivateTransactionReceiveRawResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFPrivateTransactionReceiveRawResult result) {
