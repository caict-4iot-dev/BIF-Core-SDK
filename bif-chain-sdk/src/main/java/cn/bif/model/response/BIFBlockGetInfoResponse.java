...
public class BIFBlockGetInfoResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFBlockGetInfoResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFBlockGetInfoResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFBlockGetInfoResult result) {
