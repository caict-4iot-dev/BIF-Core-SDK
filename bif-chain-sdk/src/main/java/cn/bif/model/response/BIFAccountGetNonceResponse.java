...
public class BIFAccountGetNonceResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFAccountGetNonceResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFAccountGetNonceResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFAccountGetNonceResult result) {
