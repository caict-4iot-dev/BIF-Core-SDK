...
public class BIFTransactionPrivateContractCallResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFTransactionPrivateContractCallResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFTransactionPrivateContractCallResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFTransactionPrivateContractCallResult result) {
