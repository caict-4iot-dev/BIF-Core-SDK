...
public class BIFPrivateTransactionReceiveResponse extends BIFBaseResponse {
     ...
     * @Method getResult
     * @Params []
     * @Return PrivateTransactionReceiveResult
     */
     ...
     * @Return void
     */
    public void setResult(BIFPrivateTransactionReceiveResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFPrivateTransactionReceiveResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFPrivateTransactionReceiveResult result) {
