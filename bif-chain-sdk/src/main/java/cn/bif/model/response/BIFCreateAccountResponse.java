...
public class BIFCreateAccountResponse extends BIFBaseResponse {
     ...
     * @Return void
     */
    public void setResult(BIFAccountCreateAccountResult result) {
        this.result = result;
    }
     ...
     * @Return void
     */
    public void buildResponse(SdkError sdkError, BIFAccountCreateAccountResult result) {
     ...
     * @Return void
     */
    public void buildResponse(int errorCode, String errorDesc, BIFAccountCreateAccountResult result) {
